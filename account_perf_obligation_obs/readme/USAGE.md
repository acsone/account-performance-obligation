...
When a performance obligation is created, an off-balance sheet journal entry
is posted automatically for the full commitment amount:

- Debit → Off-Balance Sheet Commitment Income Account (or Expense Account for
  expense obligations)
- Credit → Off-Balance Sheet Commitment Counterpart Account

Both lines are linked to the obligation for traceability.
